...
def __yaml_deserial_non_dict(deserial, non_dict):
...
def yaml_deserial_str(serialized, non_dict='keep'):
    ...
    yaml_deserial = __yaml_deserial_non_dict(yaml_deserial, non_dict)
    return yaml_deserial

def yaml_deserial_file(file, non_dict='keep'):
...
def yaml_serial(unserialized, file=None, non_dict='keep'):
    ...
    if file:
        ...
        yaml_deserial = yaml_deserial_file(file)
    else:
        yaml_serial = yaml.safe_dump_all(unserialized, indent=4, sort_keys=False)
        yaml_deserial = yaml_deserial_str(yaml_serial)
